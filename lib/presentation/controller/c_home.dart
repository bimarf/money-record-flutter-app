...
class CHome extends GetxController {
  ...
  final _differenceMonth = 0.0.obs;
  double get differenceMonth => _differenceMonth.value;
  ...
  getAnalysis(String idUser) async {
    ...
    double difference = (today - yesterday).abs();
    ...
    _differenceMonth.value = (monthIncome - monthOutcome).abs();
    ...
    double percentMonth = (differenceMonth / dividerMonth) * 100;
