...
class UpdateHistoryPage extends StatefulWidget {
  UpdateHistoryPage({Key? key, required this.date, required this.idHistory}) : super(key: key);
  final String date;
...
class _UpdateHistoryPageState extends State<UpdateHistoryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: DView.appBarLeft('Update Histori'),
      body: ListView(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              DView.spaceWidth(8),
              Obx(() {
                return Text(AppFormat.currency(cUpdateHistory.total.toString()),
